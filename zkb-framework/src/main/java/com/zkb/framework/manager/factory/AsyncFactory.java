package com.zkb.framework.manager.factory;
...
import com.zkb.system.service.impl.SysLogininforServiceImpl;
    ...
    public static TimerTask syncSessionToDb(final OnlineSession session)
    {
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                online.setStartTimestamp(session.getStartTimestamp().getTime());
